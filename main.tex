...
definitely the liaisons with π, e and γ, and rehabilitates String theories, also abandoned by a
majority [27].
...
mentioning a crucial point: he predicted the tau fermion with a right order of mass, 30 years beforeits surprising discovery, calling it Heavy Mesotron [1].
...
with a scientific theory. Secondly, in quantum physics, the so-called `incertainty principle`, which are
...
Poincaré, the father of 4D Relativity Theory recommended. Indeed their confusion, by writing c =
1, impeded the fact that the Hubble-Lemaître radius R is a trivial length.
